...
namespace NXD\Component\Equipmentmanager\Administrator\View\Item;
...
class HtmlView extends BaseHtmlView
{
	...
	private function addToolbar(): void
	{
		...
		ToolbarHelper::title($isNew ? Text::_('COM_EQUIPMENT_MANAGER_NEW_EQUIPMENT_ITEM')
			: Text::_('COM_EQUIPMENT_MANAGER_EDIT_EQUIPMENT_ITEM'),
