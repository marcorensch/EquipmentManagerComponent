...
class AdministratorService
{
	...
	public function association($itemId)
	{
		...
		// Get the associations for items
		...
		// Get the associations for Packages
		if ($associations = Associations::getAssociations('com_equipmentmanager', '#__equipmentmanager_packages', 'com_equipmentmanager.package', $itemId, 'id', null))
		{
			foreach ($associations as $tag => $associated)
			{
				$associations[$tag] = (int) $associated->id;
