...
/**
 * Methods supporting a list of equipmentmanager records.
 *
 * @since  1.0
 */
class PackagesModel extends ListModel
{
	...
	protected function getListQuery(): \Joomla\Database\QueryInterface
	{
		...
		$query->from($db->quoteName('#__equipmentmanager_packages', 'a'));
			...
			$subQuery = $db->getQuery(true)
				...
				->where(
					[
						...
						$db->quoteName('asso1.context') . ' = ' . $db->quote('com_equipmentmanager.package'),
					]
				);
